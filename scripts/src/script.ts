...
function findAttr(a:number){ //returns: kings, queens, jacks, 10-2 and aces
    let cardNumbers = [];
...
function findType(a:number){ //returns: spades, hearts, clubs, diamonds
    let cardNumbers = [];
...
function findColor(a:number){ //returns: black, red
    let cardNumbers = [];
